...
#Check if search term was entered into the HTML form, if not then output notice asking them to enter a search again
       if drug=="":
            ...
            FormattedPage = "<html><head><meta name='viewport' content='width=device-width, initial-scale=1.0'><script async src="https://www.googletagmanager.com/gtag/js?id=G-EESD1S9033"></script><script> window.dataLayer = window.dataLayer || []; function gtag(){dataLayer.push(arguments);} gtag('js', new Date()); gtag('config', 'G-EESD1S9033');</script><style>h2 {font-size:1.4em;} .resultslogo {float:left;} .responsecontent {margin-left:120px; margin-top:25px;} @media only screen and (max-width: 600px) {.resultslogo {grid-area: 1 / span 3; float:none; height:auto;} .responsecontent {grid-area: 2 / span 3; margin-left:auto; margin-top:auto;} .resultsfooter {grid-area: 3 / span 3;} .resultslogoimage {display:block; margin-left:auto; margin-right: auto;</style></head><body>" + "<div class='resultslogo' style='margin-top:10px'><img class='resultslogoimage' width='100px' src='https://raw.githubusercontent.com/Twostap/rxstring/refs/heads/main/rxstringcropped.png'/></div><div class='responsecontent' style='font-family:arial; font-size:.8em;'><h2>Query Responses</h2>" + completestring + "<br><br>" +  "<form><input type='button' style='color: white; background-color: #01789f; border:1px solid black; padding:4px 10px' value='New search' onclick='window.history.go(-1)'></form>" + "</div><div style='margin-top: auto'><p style='font-size:.6em;'><br><br>© Copyright 2025 Tyler Ostapyk</p></div>"
...
#Build results page based on values passed from each section above
             if MeSHSearch==None and RXSearch==None and WikidataSearch==None and PubChemSearch==None and DrugBankSearch==None and EmtreeSearch==None:
             ...
             elif MESHtermcheck==0 and rxnormstring==0 and combined==0 and PubTerms==0 and DrugBankTerms==0 and EmtreeTerms!=0:            
                 ...
                 completestring = "<b>MeSH  term:</b> " + "<a target='blank' href='" + MESHnode +"'>" + MESHtermreplaced + "</a>" + "<br><br><b>RXCUI:</b> " + "<a target='blank' href='https://mor.nlm.nih.gov/RxNav/search?searchBy=RXCUI&searchTerm=" + idnumber + "'>" + idnumber +"</a>" + "<br><br><b>Wikidata QID:</b> " + QID + "<br><br><b>CID:</b> "  + "<a target='blank' href='https://pubchem.ncbi.nlm.nih.gov/compound/" + cidNode + "'>" + cidNode + "</a>" + "<br><br>" + DrugBankMatch + "<br><br>" + EmtreeMatch + "<br><br><h2>Search string</h2>" + MESHtermstring + " OR " + rxnormstring + " OR " + combined + PubTerms              
             elif MESHtermcheck!=0 and rxnormstring!=0 and combined!=0 and PubTerms!=0 and DrugBankTerms!=0 and EmtreeTerms==0:
                 completestring = "<b>MeSH  term:</b> " + "<a target='blank' href='" + MESHnode +"'>" + MESHtermreplaced + "</a>" + "<br><br><b>RXCUI:</b> " + "<a target='blank' href='https://mor.nlm.nih.gov/RxNav/search?searchBy=RXCUI&searchTerm=" + idnumber + "'>" + idnumber +"</a>" + "<br><br><b>Wikidata QID:</b> " + QID + "<br><br><b>CID:</b> "  + "<a target='blank' href='https://pubchem.ncbi.nlm.nih.gov/compound/" + cidNode + "'>" + cidNode + "</a>" + "<br><br><b>DrugBank ID:  </b>" + "<a target='blank' href='https://go.drugbank.com/drugs/" + DrugBankid  + "'>" + DrugBankid + "</a>" + "<br><br>" + EmtreeMatch + "<br><br><h2>Search string</h2>" + MESHtermstring + " OR " + rxnormstring + " OR " + PubTerms + " OR " + combined + " OR " + DrugBankTerms
             elif MESHtermcheck!=0 and rxnormstring!=0 and combined!=0 and PubTerms==0 and DrugBankTerms!=0 and EmtreeTerms==0:
                 completestring = "<b>MeSH  term:</b> " + "<a target='blank' href='" + MESHnode +"'>" + MESHtermreplaced + "</a>" + "<br><br><b>RXCUI:</b> " + "<a target='blank' href='https://mor.nlm.nih.gov/RxNav/search?searchBy=RXCUI&searchTerm=" + idnumber + "'>" + idnumber +"</a>" + "<br><br><b>Wikidata QID:</b> " + QID + "<br><br>" + PubMatch + "<br><br><b>DrugBank ID:  </b>" + "<a target='blank' href='https://go.drugbank.com/drugs/" + DrugBankid  + "'>" + DrugBankid + "</a>" + "<br><br>" + EmtreeMatch + "<br><br><h2>Search string</h2>" + MESHtermstring + " OR " + rxnormstring + " OR " + combined + " OR " + DrugBankTerms    
             elif MESHtermcheck!=0 and rxnormstring==0 and combined==0 and PubTerms==0 and DrugBankTerms==0 and EmtreeTerms==0:
                 ...
                 completestring = MeshMatch + "<br><br><b>RXCUI:</b> " + "<a target='blank' href='https://mor.nlm.nih.gov/RxNav/search?searchBy=RXCUI&searchTerm=" + idnumber + "'>" + idnumber +"</a>" + "<br><br><b>Wikidata QID:</b> " + QID + "<br><br><b>CID:</b> "  + "<a target='blank' href='https://pubchem.ncbi.nlm.nih.gov/compound/" + cidNode + "'>" + cidNode + "</a>" + "<br><br><b>DrugBank ID:  </b>" + "<a target='blank' href='https://go.drugbank.com/drugs/" + DrugBankid  + "'>" + DrugBankid + "</a>" + "<br><br>" + EmtreeMatch + "<br><br><h2>Search string</h2>" + rxnormstring + " OR " + combined + " OR " + PubTerms + " OR " + DrugBankTerms
             elif MESHtermcheck!=0 and rxnormstring!=0 and combined==0 and PubTerms==0 and DrugBankTerms==0 and EmtreeTerms==0:
                 completestring = "<b>MeSH  term:</b> " + "<a target='blank' href='" + MESHnode +"'>" + MESHtermreplaced + "</a>" + "<br><br><b>RXCUI:</b> " + "<a target='blank' href='https://mor.nlm.nih.gov/RxNav/search?searchBy=RXCUI&searchTerm=" + idnumber + "'>" + idnumber +"</a>" + "<br><br>" + WikiMatch + "<br><br>" + PubMatch + "<br><br>" + DrugBankMatch + "<br><br>" + EmtreeMatch + "<br><br><h2>Search string</h2>" + MESHtermstring + " OR " + rxnormstring
             elif MESHtermcheck!=0 and rxnormstring!=0 and combined==0 and PubTerms==0 and DrugBankTerms!=0 and EmtreeTerms==0:
                 completestring = "<b>MeSH  term:</b> " + "<a target='blank' href='" + MESHnode +"'>" + MESHtermreplaced + "</a>" + "<br><br><b>RXCUI:</b> " + "<a target='blank' href='https://mor.nlm.nih.gov/RxNav/search?searchBy=RXCUI&searchTerm=" + idnumber + "'>" + idnumber +"</a>" + "<br><br>" + WikiMatch + "<br><br>" + PubMatch + "<br><br><b>DrugBank ID:  </b>" + "<a target='blank' href='https://go.drugbank.com/drugs/" + DrugBankid  + "'>" + DrugBankid + "</a>" + "<br><br>" + EmtreeMatch + "<br><br><h2>Search string</h2>" + MESHtermstring + " OR " + rxnormstring + " OR " + DrugBankTerms
             elif MESHtermcheck!=0 and rxnormstring!=0 and combined!=0 and PubTerms==0 and DrugBankTerms==0 and EmtreeTerms==0:
                 completestring = "<b>MeSH  term:</b> " + "<a target='blank' href='" + MESHnode +"'>" + MESHtermreplaced + "</a>" + "<br><br><b>RXCUI:</b> " + "<a target='blank' href='https://mor.nlm.nih.gov/RxNav/search?searchBy=RXCUI&searchTerm=" + idnumber + "'>" + idnumber +"</a>" + "<br><br><b>Wikidata QID:</b> " + QID + "<br><br>" + PubMatch + "<br><br>" + DrugBankMatch + "<br><br>" + EmtreeMatch + "<br><br><h2>Search string</h2>" + MESHtermstring + " OR " + rxnormstring + " OR " + combined
             elif MESHtermcheck!=0 and rxnormstring==0 and combined==0 and PubTerms!=0 and DrugBankTerms==0 and EmtreeTerms==0:
                 ...
                 completestring = MeshMatch + "<br><br><b>RXCUI:</b> " + "<a target='blank' href='https://mor.nlm.nih.gov/RxNav/search?searchBy=RXCUI&searchTerm=" + idnumber + "'>" + idnumber +"</a>" + "<br><br>" + WikiMatch + "<br><br>" + PubMatch + "<br><br>" + DrugBankMatch + "<br><br>" + EmtreeMatch + "<br><br><h2>Search string</h2>" + rxnormstring              
             elif MESHtermcheck==0 and rxnormstring!=0 and combined!=0 and PubTerms==0 and DrugBankTerms==0 and EmtreeTerms==0:
                 completestring = MeshMatch + "<br><br><b>RXCUI:</b> " + "<a target='blank' href='https://mor.nlm.nih.gov/RxNav/search?searchBy=RXCUI&searchTerm=" + idnumber + "'>" + idnumber +"</a>" + "<br><br><b>Wikidata QID:</b> " + QID + "<br><br>" + PubMatch + "<br><br>" + DrugBankMatch + "<br><br>" + EmtreeMatch + "<br><br><h2>Search string</h2>" + rxnormstring + " OR " + combined
             elif MESHtermcheck==0 and rxnormstring!=0 and combined==0 and PubTerms!=0 and DrugBankTerms==0 and EmtreeTerms==0:
                 completestring = MeshMatch + "<br><br><b>RXCUI:</b> " + "<a target='blank' href='https://mor.nlm.nih.gov/RxNav/search?searchBy=RXCUI&searchTerm=" + idnumber + "'>" + idnumber +"</a>" + "<br><br>" + WikiMatch + "<br><br><b>CID:</b> "  + "<a target='blank' href='https://pubchem.ncbi.nlm.nih.gov/compound/" + cidNode + "'>" + cidNode + "</a>" + "<br><br>" + DrugBankMatch + "<br><br>" + EmtreeMatch + "<br><br><h2>Search string</h2>" + rxnormstring + " OR " + PubTerms
             elif MESHtermcheck==0 and rxnormstring==0 and combined!=0 and PubTerms==0 and DrugBankTerms==0 and EmtreeTerms==0:
                 ...
                 completestring = "<b>MeSH  term:</b> " + "<a target='blank' href='" + MESHnode +"'>" + MESHtermreplaced + "</a>" + "<br><br><b>RXCUI:</b> " + "<a target='blank' href='https://mor.nlm.nih.gov/RxNav/search?searchBy=RXCUI&searchTerm=" + idnumber + "'>" + idnumber +"</a>" + "<br><br>" + WikiMatch + "<br><br><b>CID:</b> "  + "<a target='blank' href='https://pubchem.ncbi.nlm.nih.gov/compound/" + cidNode + "'>" + cidNode + "</a>" + "<br><br><b>DrugBank ID:  </b>" + "<a target='blank' href='https://go.drugbank.com/drugs/" + DrugBankid  + "'>" + DrugBankid + "</a>" + "<br><br>" + EmtreeMatch + "<br><br><h2>Search string</h2>" + MESHtermstring + " OR " + rxnormstring + " OR " + PubTerms + " OR " + DrugBankTerms             
             elif MESHtermcheck!=0 and rxnormstring==0 and combined!=0 and PubTerms==0 and DrugBankTerms!=0 and EmtreeTerms==0:
                 ...
                 completestring = MeshMatch + "<br><br><b>RXCUI:</b> " + "<a target='blank' href='https://mor.nlm.nih.gov/RxNav/search?searchBy=RXCUI&searchTerm=" + idnumber + "'>" + idnumber +"</a>" + "<br><br><b>Wikidata QID:</b> " + QID + "<br><br><b>CID: </b>"  + "<a target='blank' href='https://pubchem.ncbi.nlm.nih.gov/compound/" + cidNode + "'>" + cidNode + "</a>" + "<br><br>" + DrugBankMatch + "<br><br>" + EmtreeMatch + "<br><br><h2>Search string</h2>" + rxnormstring + " OR " + combined + " OR " + PubTerms
             elif MESHtermcheck==0 and rxnormstring!=0 and combined==0 and PubTerms!=0 and DrugBankTerms!=0 and EmtreeTerms==0:
                 completestring = MeshMatch + "<br><br><b>RXCUI:</b> " + "<a target='blank' href='https://mor.nlm.nih.gov/RxNav/search?searchBy=RXCUI&searchTerm=" + idnumber + "'>" + idnumber +"</a>" + "<br><br>" + WikiMatch + "<br><br><b>CID: </b>"  + "<a target='blank' href='https://pubchem.ncbi.nlm.nih.gov/compound/" + cidNode + "'>" + cidNode + "</a>" + "<br><br><b>DrugBank ID:  </b>" + "<a target='blank' href='https://go.drugbank.com/drugs/" + DrugBankid  + "'>" + DrugBankid + "</a>" + "<br><br>" + EmtreeMatch + "<br><br><h2>Search string</h2>" + rxnormstring + " OR " + " OR " + PubTerms + " OR " + DrugBankTerms
             elif MESHtermcheck==0 and rxnormstring!=0 and combined!=0 and PubTerms==0 and DrugBankTerms!=0 and EmtreeTerms==0:
                 completestring = MeshMatch + "<br><br><b>RXCUI:</b> " + "<a target='blank' href='https://mor.nlm.nih.gov/RxNav/search?searchBy=RXCUI&searchTerm=" + idnumber + "'>" + idnumber +"</a>" + "<br><br><b>Wikidata QID:</b> " + QID + "<br><br>" + PubMatch + "<br><br><b>DrugBank ID:  </b>" + "<a target='blank' href='https://go.drugbank.com/drugs/" + DrugBankid  + "'>" + DrugBankid + "</a>" + "<br><br>" + EmtreeMatch + "<br><br><h2>Search string</h2>" + rxnormstring + " OR " + combined + " OR " + DrugBankTerms
             elif MESHtermcheck==0 and rxnormstring!=0 and combined==0 and PubTerms==0 and DrugBankTerms!=0 and EmtreeTerms==0:
                 completestring = MeshMatch + "<br><br><b>RXCUI:</b> " + "<a target='blank' href='https://mor.nlm.nih.gov/RxNav/search?searchBy=RXCUI&searchTerm=" + idnumber + "'>" + idnumber +"</a>" + "<br><br>" + WikiMatch + "<br><br>" + PubMatch + "<br><br><b>DrugBank ID:  </b>" + "<a target='blank' href='https://go.drugbank.com/drugs/" + DrugBankid  + "'>" + DrugBankid + "</a>" + "<br><br>" + EmtreeMatch + "<br><br><h2>Search string</h2>" + rxnormstring + " OR " + DrugBankTerms
             elif MESHtermcheck==0 and rxnormstring==0 and combined!=0 and PubTerms!=0 and DrugBankTerms!=0 and EmtreeTerms==0:
...
#Emtree Found
                 ...
                 completestring = "<b>MeSH  term:</b> " + "<a target='blank' href='" + MESHnode +"'>" + MESHtermreplaced + "</a>" + "<br><br><b>RXCUI:</b> " + "<a target='blank' href='https://mor.nlm.nih.gov/RxNav/search?searchBy=RXCUI&searchTerm=" + idnumber + "'>" + idnumber +"</a>" + "<br><br><b>Wikidata QID:</b> " + QID + "<br><br><b>CID:</b> " + "<a target='blank' href='https://pubchem.ncbi.nlm.nih.gov/compound/" + cidNode + "'>" + cidNode + "</a>" + "<br><br>" + DrugBankMatch + "<br><br>" + "<b>Emtree Term: </b>" + efilename + "<br><br><h2>Search string</h2>" + MESHtermstring + " OR " + rxnormstring + " OR " + combined + PubTerms + " OR " + EmtreeTerms              
             elif MESHtermcheck!=0 and rxnormstring!=0 and combined!=0 and PubTerms==0 and DrugBankTerms!=0 and EmtreeTerms!=0:
                 completestring = "<b>MeSH  term:</b> " + "<a target='blank' href='" + MESHnode +"'>" + MESHtermreplaced + "</a>" + "<br><br><b>RXCUI:</b> " + "<a target='blank' href='https://mor.nlm.nih.gov/RxNav/search?searchBy=RXCUI&searchTerm=" + idnumber + "'>" + idnumber +"</a>" + "<br><br><b>Wikidata QID:</b> " + QID + "<br><br>" + PubMatch + "<br><br><b>DrugBank ID:  </b>" + "<a target='blank' href='https://go.drugbank.com/drugs/" + DrugBankid  + "'>" + DrugBankid + "</a>" + "<br><br>" + "<b>Emtree Term: </b>" + efilename + "<br><br><h2>Search string</h2>" + MESHtermstring + " OR " + rxnormstring + " OR " + combined + DrugBankTerms + " OR " + EmtreeTerms    
             elif MESHtermcheck!=0 and rxnormstring==0 and combined==0 and PubTerms==0 and DrugBankTerms==0 and EmtreeTerms!=0:
                 ...
                 completestring = MeshMatch + "<br><br><b>RXCUI:</b> " + "<a target='blank' href='https://mor.nlm.nih.gov/RxNav/search?searchBy=RXCUI&searchTerm=" + idnumber + "'>" + idnumber +"</a>" + "<br><br><b>Wikidata QID:</b> " + QID + "<br><br><b>CID:</b> "  + "<a target='blank' href='https://pubchem.ncbi.nlm.nih.gov/compound/" + cidNode + "'>" + cidNode + "</a>" + "<br><br><b>DrugBank ID:  </b>" + "<a target='blank' href='https://go.drugbank.com/drugs/" + DrugBankid  + "'>" + DrugBankid + "</a>" + "<br><br>" + "<b>Emtree Term: </b>" + efilename + "<br><br><h2>Search string</h2>" + rxnormstring + " OR " + combined + " OR " + PubTerms + " OR " + DrugBankTerms + " OR " + EmtreeTerms
             elif MESHtermcheck!=0 and rxnormstring!=0 and combined==0 and PubTerms==0 and DrugBankTerms==0 and EmtreeTerms!=0:
                 completestring = "<b>MeSH  term:</b> " + "<a target='blank' href='" + MESHnode +"'>" + MESHtermreplaced + "</a>" + "<br><br><b>RXCUI:</b> " + "<a target='blank' href='https://mor.nlm.nih.gov/RxNav/search?searchBy=RXCUI&searchTerm=" + idnumber + "'>" + idnumber +"</a>" + "<br><br>" + WikiMatch + "<br><br>" + PubMatch + "<br><br>" + DrugBankMatch + "<br><br>" + "<b>Emtree Term: </b>" + efilename + "<br><br><h2>Search string</h2>" + MESHtermstring + " OR " + rxnormstring + " OR " + EmtreeTerms
             elif MESHtermcheck!=0 and rxnormstring!=0 and combined==0 and PubTerms==0 and DrugBankTerms!=0 and EmtreeTerms!=0:
                 completestring = "<b>MeSH  term:</b> " + "<a target='blank' href='" + MESHnode +"'>" + MESHtermreplaced + "</a>" + "<br><br><b>RXCUI:</b> " + "<a target='blank' href='https://mor.nlm.nih.gov/RxNav/search?searchBy=RXCUI&searchTerm=" + idnumber + "'>" + idnumber +"</a>" + "<br><br>" + WikiMatch + "<br><br>" + PubMatch + "<br><br><b>DrugBank ID:  </b>" + "<a target='blank' href='https://go.drugbank.com/drugs/" + DrugBankid  + "'>" + DrugBankid + "</a>" + "<br><br>" + "<b>Emtree Term: </b>" + efilename + "<br><br><h2>Search string</h2>" + MESHtermstring + " OR " + rxnormstring + " OR " + DrugBankTerms + " OR " + EmtreeTerms
             elif MESHtermcheck!=0 and rxnormstring!=0 and combined!=0 and PubTerms==0 and DrugBankTerms==0 and EmtreeTerms!=0:
                 completestring = "<b>MeSH  term:</b> " + "<a target='blank' href='" + MESHnode +"'>" + MESHtermreplaced + "</a>" + "<br><br><b>RXCUI:</b> " + "<a target='blank' href='https://mor.nlm.nih.gov/RxNav/search?searchBy=RXCUI&searchTerm=" + idnumber + "'>" + idnumber +"</a>" + "<br><br><b>Wikidata QID:</b> " + QID + "<br><br>" + PubMatch + "<br><br>" + DrugBankMatch + "<br><br>" + "<b>Emtree Term: </b>" + efilename + "<br><br><h2>Search string</h2>" + MESHtermstring + " OR " + rxnormstring + " OR " + combined + " OR " + EmtreeTerms
             elif MESHtermcheck!=0 and rxnormstring==0 and combined==0 and PubTerms!=0 and DrugBankTerms==0 and EmtreeTerms!=0:
                 ...
                 completestring = "<b>MeSH  term:</b> " + "<a target='blank' href='" + MESHnode +"'>" + MESHtermreplaced + "</a>" + "<br><br><b>RXCUI:</b> " + "<a target='blank' href='https://mor.nlm.nih.gov/RxNav/search?searchBy=RXCUI&searchTerm=" + idnumber + "'>" + idnumber +"</a>" + "<br><br>" + WikiMatch + "<br><br><b>CID:</b> "  + "<a target='blank' href='https://pubchem.ncbi.nlm.nih.gov/compound/" + cidNode + "'>" + cidNode + "</a>" + "<br><br>" + DrugBankMatch + "<br><br>" + "<b>Emtree Term: </b>" + efilename + "<br><br><h2>Search string</h2>" + MESHtermstring + " OR " + rxnormstring + " OR " + PubTerms + " OR " + EmtreeTerms    
             elif MESHtermcheck!=0 and rxnormstring==0 and combined!=0 and PubTerms==0 and DrugBankTerms==0 and EmtreeTerms!=0:
                 ...
                 completestring = MeshMatch + "<br><br><b>RXCUI:</b> " + "<a target='blank' href='https://mor.nlm.nih.gov/RxNav/search?searchBy=RXCUI&searchTerm=" + idnumber + "'>" + idnumber +"</a>" + "<br><br>" + WikiMatch + "<br><br>" + PubMatch + "<br><br>" + DrugBankMatch + "<br><br>" + "<b>Emtree Term: </b>" + efilename + "<br><br><h2>Search string</h2>" + rxnormstring + " OR " + EmtreeTerms            
             elif MESHtermcheck==0 and rxnormstring!=0 and combined!=0 and PubTerms==0 and DrugBankTerms==0 and EmtreeTerms!=0:
                 completestring = MeshMatch + "<br><br><b>RXCUI:</b> " + "<a target='blank' href='https://mor.nlm.nih.gov/RxNav/search?searchBy=RXCUI&searchTerm=" + idnumber + "'>" + idnumber +"</a>" + "<br><br><b>Wikidata QID:</b> " + QID + "<br><br>" + PubMatch + "<br><br>" + DrugBankMatch + "<br><br>" + "<b>Emtree Term: </b>" + efilename + "<br><br><h2>Search string</h2>" + rxnormstring + " OR " + combined + " OR " + EmtreeTerms
             elif MESHtermcheck==0 and rxnormstring!=0 and combined==0 and PubTerms!=0 and DrugBankTerms==0 and EmtreeTerms!=0:
                 completestring = MeshMatch + "<br><br><b>RXCUI:</b> " + "<a target='blank' href='https://mor.nlm.nih.gov/RxNav/search?searchBy=RXCUI&searchTerm=" + idnumber + "'>" + idnumber +"</a>" + "<br><br>" + WikiMatch + "<br><br><b>CID:</b> "  + "<a target='blank' href='https://pubchem.ncbi.nlm.nih.gov/compound/" + cidNode + "'>" + cidNode + "</a>" + "<br><br>" + DrugBankMatch + "<br><br>" + "<b>Emtree Term: </b>" + efilename + "<br><br><h2>Search string</h2>" + rxnormstring + " OR " + PubTerms + " OR " + EmtreeTerms
             elif MESHtermcheck==0 and rxnormstring==0 and combined!=0 and PubTerms==0 and DrugBankTerms==0 and EmtreeTerms!=0:
                 ...
                 completestring = "<b>MeSH  term:</b> " + "<a target='blank' href='" + MESHnode +"'>" + MESHtermreplaced + "</a>" + "<br><br><b>RXCUI:</b> " + "<a target='blank' href='https://mor.nlm.nih.gov/RxNav/search?searchBy=RXCUI&searchTerm=" + idnumber + "'>" + idnumber +"</a>" + "<br><br>" + WikiMatch + "<br><br><b>CID:</b> "  + "<a target='blank' href='https://pubchem.ncbi.nlm.nih.gov/compound/" + cidNode + "'>" + cidNode + "</a>" + "<br><br><b>DrugBank ID:  </b>" + "<a target='blank' href='https://go.drugbank.com/drugs/" + DrugBankid  + "'>" + DrugBankid + "</a>" + "<br><br>" + "<b>Emtree Term: </b>" + efilename + "<br><br><h2>Search string</h2>" + MESHtermstring + " OR " + rxnormstring + " OR " + PubTerms + " OR " + DrugBankTerms + " OR " + EmtreeTerms           
             elif MESHtermcheck!=0 and rxnormstring==0 and combined!=0 and PubTerms==0 and DrugBankTerms!=0 and EmtreeTerms!=0:
                 ...
                 completestring = MeshMatch + "<br><br><b>RXCUI:</b> " + "<a target='blank' href='https://mor.nlm.nih.gov/RxNav/search?searchBy=RXCUI&searchTerm=" + idnumber + "'>" + idnumber +"</a>" + "<br><br><b>Wikidata QID:</b> " + QID + "<br><br><b>CID: </b>"  + "<a target='blank' href='https://pubchem.ncbi.nlm.nih.gov/compound/" + cidNode + "'>" + cidNode + "</a>" + "<br><br>" + DrugBankMatch + "<br><br>" + "<b>Emtree Term: </b>" + efilename + "<br><br><h2>Search string</h2>" + rxnormstring + " OR " + combined + " OR " + PubTerms + " OR " + EmtreeTerms
             elif MESHtermcheck==0 and rxnormstring!=0 and combined==0 and PubTerms!=0 and DrugBankTerms!=0 and EmtreeTerms!=0:
                 completestring = MeshMatch + "<br><br><b>RXCUI:</b> " + "<a target='blank' href='https://mor.nlm.nih.gov/RxNav/search?searchBy=RXCUI&searchTerm=" + idnumber + "'>" + idnumber +"</a>" + "<br><br>" + WikiMatch + "<br><br><b>CID: </b>"  + "<a target='blank' href='https://pubchem.ncbi.nlm.nih.gov/compound/" + cidNode + "'>" + cidNode + "</a>" + "<br><br><b>DrugBank ID:  </b>" + "<a target='blank' href='https://go.drugbank.com/drugs/" + DrugBankid  + "'>" + DrugBankid + "</a>" + "<br><br>" + "<b>Emtree Term: </b>" + efilename + "<br><br><h2>Search string</h2>" + rxnormstring + " OR " + " OR " + PubTerms + " OR " + DrugBankTerms + " OR " + EmtreeTerms
             elif MESHtermcheck==0 and rxnormstring!=0 and combined!=0 and PubTerms==0 and DrugBankTerms!=0 and EmtreeTerms!=0:
                 completestring = MeshMatch + "<br><br><b>RXCUI:</b> " + "<a target='blank' href='https://mor.nlm.nih.gov/RxNav/search?searchBy=RXCUI&searchTerm=" + idnumber + "'>" + idnumber +"</a>" + "<br><br><b>Wikidata QID:</b> " + QID + "<br><br>" + PubMatch + "<br><br><b>DrugBank ID:  </b>" + "<a target='blank' href='https://go.drugbank.com/drugs/" + DrugBankid  + "'>" + DrugBankid + "</a>" + "<br><br>" + "<b>Emtree Term: </b>" + efilename + "<br><br><h2>Search string</h2>" + rxnormstring + " OR " + combined + " OR " + DrugBankTerms + " OR " + EmtreeTerms
             elif MESHtermcheck==0 and rxnormstring!=0 and combined==0 and PubTerms==0 and DrugBankTerms!=0 and EmtreeTerms!=0:
                 completestring = MeshMatch + "<br><br><b>RXCUI:</b> " + "<a target='blank' href='https://mor.nlm.nih.gov/RxNav/search?searchBy=RXCUI&searchTerm=" + idnumber + "'>" + idnumber +"</a>" + "<br><br>" + WikiMatch + "<br><br>" + PubMatch + "<br><br><b>DrugBank ID:  </b>" + "<a target='blank' href='https://go.drugbank.com/drugs/" + DrugBankid  + "'>" + DrugBankid + "</a>" + "<br><br>" + "<b>Emtree Term: </b>" + efilename + "<br><br><h2>Search string</h2>" + rxnormstring + " OR " + DrugBankTerms + " OR " + EmtreeTerms
             elif MESHtermcheck==0 and rxnormstring==0 and combined!=0 and PubTerms!=0 and DrugBankTerms!=0 and EmtreeTerms!=0:
                 ...
                 completestring = "Match found in all data sources" + "<br><br><b>MeSH term:</b> " + "<a target='blank' href='" + MESHnode +"'>" + MESHtermreplaced + "</a>" + "<br><br><b>RXCUI:</b> " + "<a target='blank' href='https://mor.nlm.nih.gov/RxNav/search?searchBy=RXCUI&searchTerm=" + idnumber + "'>" + idnumber +"</a>" + "<br><br><b>Wikidata QID:</b> " + QID + "<br><br><b>CID:</b> "  + "<a target='blank' href='https://pubchem.ncbi.nlm.nih.gov/compound/" + cidNode + "'>" + cidNode + "</a>" + "<br><br><b>DrugBank ID:  </b>" + "<a target='blank' href='https://go.drugbank.com/drugs/" + DrugBankid  + "'>" + DrugBankid + "</a>" + "<br><br>" + "<b>Emtree Term: </b>" + efilename + "<br><br><h2>Search string</h2>" + MESHtermstring + " OR " + rxnormstring + " OR " + combined + " OR " + PubTerms + " OR " + DrugBankTerms + " OR " + EmtreeTerms
...
#If phrase search isn't on join terms with OR but put these terms in quotation marks because they can cause errors in bibliographic databases
                 ...
                 FormattedPage = "<html><head><meta name='viewport' content='width=device-width, initial-scale=1.0'><script async src="https://www.googletagmanager.com/gtag/js?id=G-EESD1S9033"></script><script> window.dataLayer = window.dataLayer || []; function gtag(){dataLayer.push(arguments);} gtag('js', new Date()); gtag('config', 'G-EESD1S9033');</script><style>h2 {font-size:1.4em;} .resultslogo {float:left;} .responsecontent {margin-left:120px; margin-top:25px;} @media only screen and (max-width: 600px) {.resultslogo {grid-area: 1 / span 3; float:none; height:auto;} .responsecontent {grid-area: 2 / span 3; margin-left:auto;} .resultsfooter {grid-area: 3 / span 3;} .resultslogoimage {display:block; margin-left:auto; margin-right: auto;}</style></head><body>" + "<div class='resultslogo' style='margin-top:10px'><img class='resultslogoimage' width='100px' src='https://raw.githubusercontent.com/Twostap/rxstring/refs/heads/main/rxstringcropped.png'/></div><div class='responsecontent' style='font-family:arial; font-size:.8em'><h2>Query Responses</h2>" + completestring +  "<br><br>" +  "<form><input type='button' style='color: white; background-color: #01789f; border:1px solid black; padding:4px 10px' value='New search' onclick='window.history.go(-1)'></form>"
