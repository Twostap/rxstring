...
#If phrase search isn't on join terms with OR but put these terms in quotation marks because they can cause errors in bibliographic databases
                     ...
                     FormattedPage = "<div style='display: flex; flex-direction: column; height: 100%'>" + "<div><h1>Drug Data Tool</h1><div><h2>Query Responses</h2></div>" + completeintro +  "<br><br>" +  "<form><input type='button' value='New search' onclick='window.history.go(-1)'></form>" + "<h2>Search string</h2>" + dedupedstring
