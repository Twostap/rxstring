...
#If phrase search is on put quotation marks around each separate term when joining
                 if PhraseSearch=="on":
                     ...
                     FormattedPage = "<html><head><meta name='viewport' content='width=device-width, initial-scale=1.0'><style>.resultslogo {float:left} .resultslogoimage {margin-right:20px} @media only screen and (max-width: 600px) {.resultslogo {grid-area: 1 / span 3; float:none} .resultscontent {grid-area: 2 / span 3;} .resultsfooter {grid-area: 3 / span 3;} .resultslogoimage {display:block; margin-left:auto; margin-right: auto;}</style></head><body>" + "<div class='resultslogo' style='margin-top:10px'><img class='resultslogoimage' width='100px' src='https://raw.githubusercontent.com/Twostap/rxstring/refs/heads/main/rxstringcropped.png'/></div><div class='responsecontent'><h2>Query Responses</h2>" + completeintro +  "<br><br>" +  "<form><input type='button' value='New search' onclick='history.go(-1)'></form>" + "<h2>Search string</h2>" + '"' + dedupedstring + '"' 
...
#If phrase search isn't on join terms with OR but put these terms in quotation marks because they can cause errors in bibliographic databases
                     ...
                     FormattedPage = "<html><head><meta name='viewport' content='width=device-width, initial-scale=1.0'><style>.resultslogo {float:left} .resultslogoimage {margin-right:20px} @media only screen and (max-width: 600px) {.resultslogo {grid-area: 1 / span 3; float:none} .resultscontent {grid-area: 2 / span 3;} .resultsfooter {grid-area: 3 / span 3;} .resultslogoimage {display:block; margin-left:auto; margin-right: auto;}</style></head><body>" + "<div class='resultslogo' style='margin-top:10px'><img class='resultslogoimage' width='100px' src='https://raw.githubusercontent.com/Twostap/rxstring/refs/heads/main/rxstringcropped.png'/></div><div class='responsecontent'><h2>Query Responses</h2>" + completeintro +  "<br><br>" +  "<form><input type='button' value='New search' onclick='window.history.go(-1)'></form>" + "<h2>Search string</h2>" + dedupedstring
 
             else:

                 FormattedPage = "<html><head><meta name='viewport' content='width=device-width, initial-scale=1.0'><style>.resultslogo {float:left} .resultslogoimage {margin-right:20px} @media only screen and (max-width: 600px) {.resultslogo {grid-area: 1 / span 3; float:none} .resultscontent {grid-area: 2 / span 3;} .resultsfooter {grid-area: 3 / span 3;} .resultslogoimage {display:block; margin-left:auto; margin-right: auto;}</style></head><body>" + "<div class='resultslogo' style='margin-top:10px'><img class='resultslogoimage' width='100px' src='https://raw.githubusercontent.com/Twostap/rxstring/refs/heads/main/rxstringcropped.png'/></div><div class='responsecontent'><h2>Query Responses</h2>" + completestring +  "<br><br>" +  "<form><input type='button' value='New search' onclick='window.history.go(-1)'></form>"
