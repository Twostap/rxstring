...
4. The truncation option will add an asterisk (*) following each term to search for alternate word endings in some databases. The first word option includes only the first word from each term and the second word option includes only the first two words from each term.
5. Click Search.
